...
const ClonePropertyUnit = () => {
    ...
    const handleCloneProperty = async () => {
        ...
        await fetch('/api/admin/properties/clone-unit', {
            method: 'POST',
            body: form_data
        ...
        if (prop_fetched) {
            ...
            setFormData(() => {
                return {
                    ...
                    unit_data: [{
                        unit_id: 0,
                        unit_number: `${property.unit_number} - Copy`,
                        beds: property.beds,
    ...
    return (
        <div className='w-full'>
            <div className='container m-auto lg:max-w-[1100px]'>
                ...
                <PageTitle text={`Clone Unit #${property.unit_number}`} show_back={true} />
                    ...
                    <div className='w-full flex justify-end mt-2'>
                        {
                            !is_updating
                                ? <div className='px-8 py-4 bg-primary text-white rounded-md cursor-pointer hover:drop-shadow-xl'
                                    onClick={() => handleCloneProperty()}>Clone Unit</div>
...
export default ClonePropertyUnit
