            ...
            <div className='flex items-center'>
                {
                    show_back && (
                        <span>
                            <button className='bg-red-600 text-white flex items-center justify-center py-1 px-4 h-10 text-sm font-medium 
                            rounded-md hover:drop-shadow-xl' onClick={() => router.back()}>
